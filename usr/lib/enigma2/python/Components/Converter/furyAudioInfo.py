...
class furyAudioInfo(Poll, Converter):
	...
	def __init__(self, type):
		...
		Poll.__init__(self)
		self.logger = logging.getLogger("furyAudioInfo")
...
<widget source="session.CurrentService" render="Label" position="100,100" size="200,25" font="Regular;18">
	<convert type="furyAudioInfo">AudioCodec</convert>
</widget>
"""
# Audio Icon Display:
...
<widget source="session.CurrentService" render="Pixmap" position="100,130" size="30,30">
	<convert type="furyAudioInfo">AudioIcon</convert>
