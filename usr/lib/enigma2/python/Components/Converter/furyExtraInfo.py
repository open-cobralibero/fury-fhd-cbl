...
#CurrentCrypto	                NDS	Current encryption system (short)
#CryptoBar                     	S V I Nd Co Cw P B N (color-coded)	All supported CAIDs with colors
#CryptoSeca                    	S (green/yellow/grey)	SECA status indicator
#CryptoVia	                    V (green/yellow/grey)	VIA status indicator
#CryptoSpecial              	PowerVU:2600:123456:7890	Full CAID + Provider + SID details
#CryptoNameCaid	                PowerVU:2600	Encryption name + CAID
#ResolutionString              	1920x1080p50	Resolution + scan type + FPS
#VideoCodec	                      HEVC H.265	Video codec name
#PIDInfo	                     1-1000:12345:678:910:111	ONID-TSID:SID:VPID:APID:PCRPID
#TransponderFrequencyMHz        12050	Frequency in MHz
#TransponderSymbolRate          27500	Symbol rate (DVB-S/C) / bandwidth (DVB-T)
#TransponderPolarization        H	Polarization (H/V/L/R)
#OrbitalPosition                13.0°E	Satellite position
#TunerType                    	DVB-S2	Tuner standard
#TransponderInfoMisPls      	MIS 1 AUTO 123	MIS/PLS/T2MI parameters
#roviderName                	Sky Deutschland	Service provider
#ServiceRef                     1:0:1:1234:567:890:12345678:0:0:0:	Full service reference
#All                            Multi-line service info	Combined fields (configurable)
...
class furyExtraInfo(Poll, Converter, object):
    ...
    def __init__(self, type):
        ...
        self.cryptocolors = parameters.get("PlfuryExtraInfoCryptoColors", (0x004C7D3F, 0x009F9F9F, 0x00EEEE00, 0x00FFFFFF))
    ...
    def createCryptoBar(self, info):
        ...
        colors = parameters.get("PlfuryExtraInfoColors", (0x0000FF00, 0x00FF0000, 0x00FFFFFF, 0x007F7F7F))  # "found", "not found", "available", "default" colors
