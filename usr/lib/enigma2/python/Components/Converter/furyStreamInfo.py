...
class furyStreamInfo(Converter):
	STREAMURL = 0		#output 	example.com:8000	Extracts clean stream URL/domain
	STREAMTYPE = 1		#output 	GStreamer			Identifies player engine
